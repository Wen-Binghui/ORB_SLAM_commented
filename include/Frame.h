...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        std::vector<cv::KeyPoint> mvKeysUn; // undistorted KeyPoints
        ...
        // MapPoints associated to keypoints, NULL pointer if not association with defined size
        ...
        // 是个vector 数组，有 [FRAME_GRID_COLS]*[FRAME_GRID_ROWS] 个std::vector<std::size_t>, 存放特征点分布
