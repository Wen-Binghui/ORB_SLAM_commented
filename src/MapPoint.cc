...
namespace ORB_SLAM
{
    ...
    MapPoint::MapPoint(const cv::Mat &Pos, KeyFrame *pRefKF, Map *pMap) : mnFirstKFid(pRefKF->mnId), mnTrackReferenceForFrame(0), mnLastFrameSeen(0), mnBALocalForKF(0),
    ...
    // std::map<ORB_SLAM::KeyFrame *, size_t> mObservations 中指定KeyFrame添加 idx (某KeyFrame第idx个特征)
